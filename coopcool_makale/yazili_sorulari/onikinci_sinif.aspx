<%@ Page Title="" Language="C#" MasterPageFile="~/cool_makale.master" AutoEventWireup="true" CodeFile="onikinci_sinif.aspx.cs" Inherits="onikinci_sinif" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-md-10">
         <asp:Repeater ID="rpt_onikinci_sinif_dersler" runat="server">
            <ItemTemplate>
         <div class="col-md-2">
			<div class="post">
				<a class="post-img" href="yazili_sorular.aspx"><img src="../img/2.jpg" alt=""></a>
					<div class="post-body" style="background-color:#E9EBEC; height:auto;">
						<a href="yazili_sorular.aspx"><asp:Label ID="lbl_dersler" runat="server" Text='<%#Eval("dersler") %>' style="font-family:Arial, Helvetica, sans-serif; font-style:normal; font-size:large; " Font-Bold="True"></asp:Label></a>	                                                                      															
								</div>
                                <br />
                                <br />								
                                <br />    
