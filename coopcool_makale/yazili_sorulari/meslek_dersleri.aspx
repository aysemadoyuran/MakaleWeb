<%@ Page Title="" Language="C#" MasterPageFile="~/cool_makale.master" AutoEventWireup="true" CodeFile="meslek_dersleri.aspx.cs" Inherits="meslek_dersleri" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div class="container">
        <div class="row">
            <div class="col-md-2">  
     <ul class="list-group"> 
    <li class="list-group-item list-group-item-success"><a href="/yazili_sorulari/dokuzuncu_sinif.aspx">9. Sınıf Dersleri</a></li>
     <li class="list-group-item list-group-item-info"><a href="/yazili_sorulari/onuncu_sinif.aspx">10. Sınıf Dersleri</a></li>
     <li class="list-group-item list-group-item-success"><a href=" /yazili_sorulari/onbirinci_sinif.aspx">11. Sınıf Dersleri</a></li>
     <li class="list-group-item list-group-item-info"><a href="/yazili_sorulari/onikinci_sinif.aspx">12. Sınıf Dersleri</a></li>
     <li class="list-group-item list-group-item-success"><a href="/yazili_sorulari/meslek_dersleri.aspx">Meslek Dersleri</a></li>
     </ul>
            </div>       
    <div class="col-md-10">
       <asp:Repeater ID="rpt_meslek_dersleri" runat="server">
            <ItemTemplate>
         <div class="col-md-2">
			<div class="post">
