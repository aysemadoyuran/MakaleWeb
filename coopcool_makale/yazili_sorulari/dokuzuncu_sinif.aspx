<%@ Page Title="" Language="C#" MasterPageFile="~/cool_makale.master" AutoEventWireup="true" CodeFile="dokuzuncu_sinif.aspx.cs" Inherits="dokuzuncu_sinif" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-md-10">
         <asp:Repeater ID="rpt_dokuzuncu_sinif_ders" runat="server">
            <ItemTemplate>
         <div class="col-md-2">
			<div class="post">
